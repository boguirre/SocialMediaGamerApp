...
public class ChatActivity extends AppCompatActivity {
    ...
    private void showCustomToolbar(int resource) {
        ...
        mTextVieUsername = mActionBarView.findViewById(R.id.textViewUsername);
        mTextViewRelativeTime = mActionBarView.findViewById(R.id.textViewRelativeTine);
            ...
            public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException error) {
                if (documentSnapshot.exists()){
                    if (documentSnapshot.contains("username")){
                        ...
                        mTextVieUsername.setText(mUsernameChat);
                    }
        ...
        mChatProvider.getChatByUser1AndUser2(mExtraIdUser1, mExtraIdUser2).get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            ...
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                ...
                if (size == 0){
                    ...
                    mNotificationChat = queryDocumentSnapshots.getDocuments().get(0).getLong("idNotification");
                    getMessage();
                    updateViewed();
                }
            }
    ...
    private void sendNotification(String token, String messages, Message message){
        ...
        data.put("idNotification", String.valueOf(mNotificationChat));
                    ...
                    public void onResponse(Call<FCMResponse> call, Response<FCMResponse> response) {
                        if (response.body() !=null){
                            if (response.body().getSuccess() == 1){
                                //Toast.makeText(ChatActivity.this, "La noticacion se envio correctamente", Toast.LENGTH_SHORT).show();
                            }
                            else {
                                Toast.makeText(ChatActivity.this, "La noticacion no se pudo enviar", Toast.LENGTH_SHORT).show();
                            }
                        }
                        else {
                            Toast.makeText(ChatActivity.this, "La noticacion no se pudo enviar", Toast.LENGTH_SHORT).show();
